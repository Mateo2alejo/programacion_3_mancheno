...
function guardarProducto() {
    ...
    if (!nombre || !descripcion || !precio) {
        alert("Complete todos los campos del vuelo");
        return;
    }
    ...
    if (idProductoEnEdicion !== null) {
        ...
        document.getElementById("btn_agregar").textContent = "Agregar vuelo";
    } else {
        const nuevoProducto = {
...
function editarProducto(id) {
    ...
    document.getElementById("btn_agregar").textContent = "Actualizar vuelo";
}
